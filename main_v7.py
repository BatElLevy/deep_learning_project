...
# ---------------------------------------------------------
# Separate KFold split for proteins and DNA
# ---------------------------------------------------------
...
protein_folds = list(protein_kfold.split(protein_indices))
dna_folds = list(dna_kfold.split(dna_indices))


# ---------------------------------------------------------
# Build the 3 two-dimensional folds
# ---------------------------------------------------------
...
# =========================================================
# Optional: run only one fold
# Set with environment variable FOLD_TO_RUN=1..10
# If not set, run all folds sequentially as before
# =========================================================
...
CHECKPOINT_DIR = "checkpoints_v7_preoptuna_pat25"
os.makedirs(CHECKPOINT_DIR, exist_ok=True)
RESULTS_DIR = "cv_results_v7_preoptuna_pat25"
...
for fold_idx in fold_indices:
    ...
    #
    # IMPORTANT:
    # Mean/std are calculated ONLY from training DNA.
    # Validation DNA is never used to estimate them.
    # -----------------------------------------------------
    ...
    model = ProteinDNABindingModel().to(
        device
    )
    ...
    # =========================================================
    # Save this fold's result separately
    # =========================================================
...
# =========================================================
# Final CV summary across ALL completed folds
# =========================================================
